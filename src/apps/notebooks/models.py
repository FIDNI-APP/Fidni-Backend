...
class NotebookSection(models.Model):
    ...
    Chaque section peut contenir plusieurs leçons (via NotebookLessonEntry).
    """
...
class NotebookLessonEntry(models.Model):
    """
    Represents a lesson page within a notebook section.
    ...
    is_continuation = models.BooleanField(default=False)  # If this continues from previous page
    ...
    def __str__(self):
        return f"{self.lesson.title} - Page {self.page_order} - {self.section}"
