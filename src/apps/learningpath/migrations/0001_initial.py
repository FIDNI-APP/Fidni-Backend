    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_level', models.ManyToManyField(related_name='learning_paths', to='caracteristics.classlevel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('correct_answer_indices', models.JSONField(blank=True, help_text='For multiple correct answers', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_type', models.CharField(choices=[('lesson', 'Lesson'), ('introduction', 'Introduction'), ('explanation', 'Explanation'), ('demo', 'Demo'), ('tips', 'Tips'), ('summary', 'Summary')], default='lesson', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=200)),
                ('resource_type', models.CharField(choices=[('pdf', 'PDF Document'), ('link', 'External Link'), ('exercise', 'Practice Exercise'), ('summary', 'Summary Document'), ('code', 'Code Sample'), ('slides', 'Presentation Slides')], max_length=20)),
                ('url', models.URLField()),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selected_answer_indices', models.JSONField(blank=True, null=True)),
