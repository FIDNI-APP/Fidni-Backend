...
from things.models import Exercise, Lesson, Exam
from interactions.models import Complete, Save, StudyTimeTracker
from learningpath.models import (
    UserLearningPathProgress,
    UserChapterProgress,
    PathChapter
)
from caracteristics.models import Chapter
...
def get_recommended_content(request):
    ...
    try:
        ...
        # Serialize the data
        from things.serializers import ExerciseSerializer, LessonSerializer, ExamSerializer
